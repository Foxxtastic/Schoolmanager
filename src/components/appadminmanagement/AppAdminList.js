...
export function AppAdminList(props) {
    ...
    sortingProperty = sortingProperty === null ? 'IsActive' : sortingProperty;
    const { isDescending } = useSortingDirection();

    let filterProperty = useFilterProperty();
    filterProperty = filterProperty === null ? 'IsActive' : filterProperty;
    ...
    const setSchoolAdminsFromServer = (listResponse) => {
        ...
        appSchoolAdmins(listResponse.items);
    }
        ...
        <div className={`component ${isLoading ? "loading" : ""}`} >
            ...
            <LayoutContent>
                <DataTable
                    ...
                    getRowId={AppAdmin => AppAdmin.UserId}
